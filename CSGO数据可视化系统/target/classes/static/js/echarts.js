...
$(function () {
    ...
    function echarts_1() {
        ...
        var data = [
            {value: rs.data.bs,name: '匕首'},
            {value: rs.data.sq,name: '手枪'},
            {value: rs.data.bq,name: '步枪'},
            {value: rs.data.zxwq,name: '重型武器'},
        ...
        option = {
            ...
            color: [ '#20b9cf', '#2089cf', '#205bcf','#35e02a'],
            legend: { //图例组件，颜色和名字
                x: '70%',
                y: 'center',
                orient: 'vertical',
